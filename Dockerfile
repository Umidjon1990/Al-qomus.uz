...
RUN apt-get update && apt-get install -y --no-install-recommends python3 fonts-dejavu-core fonts-hosny-amiri fonts-liberation2 fonts-noto-core libpango-1.0-0 libpangoft2-1.0-0 libharfbuzz-subset0 && rm -rf /var/lib/apt/lists/*
