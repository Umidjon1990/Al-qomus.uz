...
export function Hero({ searchTerm, setSearchTerm, totalWords }: HeroProps) {
  return (
    <section className="sticky top-14 z-40 border-b border-gray-200 bg-white/95 backdrop-blur-lg">
      <div className="max-w-4xl mx-auto px-4 py-3 sm:py-4">
        ...
        <div className="relative flex items-center rounded-xl border border-gray-300 bg-gray-50 focus-within:border-orange-500 focus-within:ring-2 focus-within:ring-orange-100">
          ...
          <input aria-label="Arabcha yoki o‘zbekcha so‘z qidirish" dir="auto" type="search"
            ...
            className="w-full h-12 sm:h-14 px-12 text-lg bg-transparent outline-none rounded-xl"
